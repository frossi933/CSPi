...
action_7 (14) = happyShift action_16
action_7 (15) = happyShift action_17
...
action_18 (7) = happyGoto action_9
...
happyReduction_12 (HappyTerminal (TEIName happy_var_1))
	 =  HappyAbsSyn8
		 (happy_var_1
	)
...
happyReduction_13 (HappyTerminal (TEOName happy_var_1))
	 =  HappyAbsSyn9
		 (happy_var_1
	)
...
happyReduction_14 (HappyTerminal (TPName happy_var_1))
	 =  HappyAbsSyn10
		 (happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TSkip -> cont 11;
	TStop -> cont 12;
	TPName happy_dollar_dollar -> cont 13;
	TEOName happy_dollar_dollar -> cont 14;
	TEIName happy_dollar_dollar -> cont 15;
	TDef -> cont 16;
	TPrefix -> cont 17;
	TPar -> cont 18;
	TExtSel -> cont 19;
