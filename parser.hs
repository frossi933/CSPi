...
happyReduction_5 ((HappyAbsSyn4  happy_var_7) `HappyStk`
	_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn4
		 (Choice happy_var_1 happy_var_3 happy_var_5 happy_var_7
	) `HappyStk` happyRest
...
happyReduction_9 (HappyAbsSyn7  happy_var_1)
	 =  HappyAbsSyn5
		 (Out happy_var_1 True
	)
happyReduction_9 _  = notHappyAtAll 

happyReduce_10 = happySpecReduce_1  6 happyReduction_10
happyReduction_10 (HappyTerminal (TEIName happy_var_1))
	 =  HappyAbsSyn6
		 (happy_var_1
	)
...
happyReduction_11 (HappyTerminal (TEOName happy_var_1))
	 =  HappyAbsSyn7
		 (happy_var_1
	)
...
happyReduction_12 (HappyTerminal (TPName happy_var_1))
	 =  HappyAbsSyn8
		 (happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TSkip -> cont 9;
	TStop -> cont 10;
	TPName happy_dollar_dollar -> cont 11;
	TEOName happy_dollar_dollar -> cont 12;
	TEIName happy_dollar_dollar -> cont 13;
	TPrefix -> cont 14;
	TChoice -> cont 15;
	TPar -> cont 16;
	TExtSel -> cont 17;
...
happyError' = HappyIdentity . errorParser
